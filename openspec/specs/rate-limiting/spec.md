...
Blast-radius bounding: global and per-recipient hourly/daily limits derived from persisted request rows, enforced before key reservation and failing closed when they cannot be evaluated.
