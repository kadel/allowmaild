...
Auditability without storing message content: every accepted request leaves a SQLite record (IDs, alias, terminal state, sanitized result code, subject/body hashes) with bounded retention.
